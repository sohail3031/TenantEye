...
import com.example.tenanteye.signup.SignUpFourActivity;
import com.example.tenanteye.signup.SignUpThreeActivity;
...
public class TenantUpdateProfilePictureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenant_update_profile_picture);
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                for (DataSnapshot dataSnapshot : task.getResult().getChildren()) {
                    if (Objects.requireNonNull(dataSnapshot.child("emailAddress").getValue()).toString().equalsIgnoreCase(emailAddress)) {
                        ...
                        Toast.makeText(TenantUpdateProfilePictureActivity.this, "Profile Picture Updated!", Toast.LENGTH_SHORT).show();

                        startActivity(new Intent(TenantUpdateProfilePictureActivity.this, TenantMoreActivity.class));
                        finish();
                    }
                }
            }
    ...
    private void savePictureToDatabase() {
        ...
        if (uri != null) {
            ...
            storageTask = storageReference.putFile(uri).addOnSuccessListener(taskSnapshot -> {
                        ...
                        Toast.makeText(TenantUpdateProfilePictureActivity.this, "Upload Successful", Toast.LENGTH_SHORT).show();
...
//                            profilePictureLink = storageReference.getDownloadUrl().toString();
                    ...
                    .addOnFailureListener(e -> Toast.makeText(TenantUpdateProfilePictureActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show())
...
//            view.setImageURI(uri);
    ...
    private void initializeAllVariables() {
        backImageView = findViewById(R.id.tenant_update_profile_picture_back_image_view);
        imageView = findViewById(R.id.tenant_update_profile_picture_upload_image_view);
        uploadImage = findViewById(R.id.tenant_update_profile_picture_image_image_view);
        uploadText = findViewById(R.id.tenant_update_profile_picture_upload_image_text_view);
        cancelButton = findViewById(R.id.tenant_update_profile_picture_cancel_button);
        saveButton = findViewById(R.id.tenant_update_profile_picture_save_button);
        progressBar = findViewById(R.id.tenant_update_profile_picture_progress_bar);
    }
}